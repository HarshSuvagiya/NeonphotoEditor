...
public class AmbilWarnaDialog {
    ...
    public interface OnAmbilWarnaListener {
        void onCancel(AmbilWarnaDialog fX_AmbilWarnaDialog);

        void onOk(AmbilWarnaDialog fX_AmbilWarnaDialog, int i);
    }
    ...
    private void forUI() {
        ...
        Layparam.setHeightWidth(this.context, this.lmain, 969, i);
        Layparam.setHeight(this.context, this.reltitle, 150);
        Layparam.setHeightAsBoth(this.context, this.ivclose, 90);
        Layparam.setMarginRight(this.context, this.ivclose, 40);
        Layparam.setHeightWidth(this.context, this.ivarrow, 100, 49);
        Layparam.setMargins(this.context, this.ivarrow, 60, 0, 60, 0);
        Layparam.setHeightWidth(this.context, this.ivok, 316, 116);
        Layparam.setHeightWidth(this.context, this.ivcancel, 316, 116);
