...
public class HeartRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public HeartRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.HEART_FOLDER;
