...
public class PizzaRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public PizzaRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.duration = 1600;
        component.src = Constant.PIZZA_FOLDER;
