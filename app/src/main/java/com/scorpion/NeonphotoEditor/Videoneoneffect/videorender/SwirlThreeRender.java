...
public class SwirlThreeRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public SwirlThreeRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.duration = 1900;
        component.src = Constant.SWIRL3_FOLDER;
