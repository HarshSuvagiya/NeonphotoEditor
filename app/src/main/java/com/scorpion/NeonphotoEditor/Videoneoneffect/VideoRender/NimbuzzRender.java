...
public class NimbuzzRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public NimbuzzRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.NIMBUZZ_FOLDER;
