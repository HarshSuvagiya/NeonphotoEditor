...
public class SwirlOneRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public SwirlOneRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.SWIRL1_FOLDER;
