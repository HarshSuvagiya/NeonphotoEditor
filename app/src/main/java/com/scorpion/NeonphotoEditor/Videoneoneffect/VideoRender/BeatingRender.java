...
public class BeatingRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public BeatingRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.BEATING_FOLDER;
