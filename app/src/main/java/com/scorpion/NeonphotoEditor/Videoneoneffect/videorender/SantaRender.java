...
public class SantaRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();
    final int size = Constant.NORMAL_STICKER_SIZE;

    public SantaRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.SANTA_FOLDER;
