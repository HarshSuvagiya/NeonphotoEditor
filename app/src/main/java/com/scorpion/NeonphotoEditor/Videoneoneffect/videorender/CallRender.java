...
public class CallRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public CallRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.duration = 2200;
        component.src = Constant.CALL_FOLDER;
