...
public class HalfRoundRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public HalfRoundRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.HALFROUND_FOLDER;
