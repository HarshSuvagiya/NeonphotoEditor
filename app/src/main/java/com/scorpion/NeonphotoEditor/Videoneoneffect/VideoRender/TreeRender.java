...
public class TreeRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public TreeRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.TREE_FOLDER;
