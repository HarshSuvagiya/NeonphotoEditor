...
public class RoundRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public RoundRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.ROUND_FOLDER;
