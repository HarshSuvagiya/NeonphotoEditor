...
public class FlamingoRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public FlamingoRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.FLAMINGO_FOLDER;
