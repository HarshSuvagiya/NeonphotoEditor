...
public class TeacupRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public TeacupRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.TEACUP_FOLDER;
