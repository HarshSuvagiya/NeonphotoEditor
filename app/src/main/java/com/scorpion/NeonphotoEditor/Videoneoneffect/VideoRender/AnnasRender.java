...
public class AnnasRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public AnnasRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.ANNAS_FOLDER;
