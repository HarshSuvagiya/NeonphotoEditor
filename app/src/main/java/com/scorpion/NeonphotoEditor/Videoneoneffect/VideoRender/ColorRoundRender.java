...
public class ColorRoundRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public ColorRoundRender(Context context, IStickerTimeController IStickerTimeController1) {
        ...
        component.src = Constant.COLORROUND_FOLDER;
