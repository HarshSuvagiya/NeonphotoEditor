...
public class HolidayRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public HolidayRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.HOLIDAY_FOLDER;
