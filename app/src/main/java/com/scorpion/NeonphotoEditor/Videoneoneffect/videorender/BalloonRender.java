...
public class BalloonRender extends StickerRender {
    private List<PointF> mPositionHistories = new ArrayList();

    public BalloonRender(Context context, IStickerTimeController fX_IStickerTimeController) {
        ...
        component.src = Constant.BALLOON_FOLDER;
