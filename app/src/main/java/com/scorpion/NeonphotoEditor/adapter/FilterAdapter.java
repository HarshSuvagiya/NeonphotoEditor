...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void forUI() {
            Layparam.setHeightAsBoth(FilterAdapter.this.context, this.relmain, 160);
            Layparam.setMarginLeft(FilterAdapter.this.context, this.relmain, 20);
            Layparam.setMarginsAsHeight(FilterAdapter.this.context, this.iv, 10);
        }
    }
}
